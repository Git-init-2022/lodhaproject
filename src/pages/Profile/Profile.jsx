            ...
            <MDBCard className="card" style={{ borderRadius: '.5rem' }}>
              <MDBRow className="g-0">
                <MDBCol md="4" className="gradient-custom text-center text-white"
                  ...
                  <MDBCardImage src="/src/assests/user.svg"
                    alt="Avatar" className="my-5" style={{ width: '100px', heigh: '100px' }} fluid />
                  <MDBTypography tag="h4">{JSON.parse(User).OwnerName}</MDBTypography>
                </MDBCol>
                <MDBCol md="8">
