...
function CulturalSection() {
    ...
    const loadBlockChainData = async () => {
        ...
        const networkData = myconfig.address;
        if (networkData !== "" && networkData !== null) {
            const contract = new web3.eth.Contract(imageUpload.abi, networkData);
    ...
    const PostCulturalSection = async (Title, Description) => {
        ...
        console.log("data: ", data.notification._id);
        const id = data.notification._id;
        console.log("Submitting file");
            ...
            const files = document.getElementsByName("receipt").item(0).files;
